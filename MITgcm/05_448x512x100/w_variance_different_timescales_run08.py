...
outdir = '/data/SO2/sio-kramosmusalem/08_globalwinds_output/'
...
fig.savefig('areas.png', format='png')
# In[6]:
...
fig.savefig('N_and_weight_run08.png', format='png')
...
print('12 hrs')
fig.savefig('Std_12hr_run08.png', format='png')
...
fig.savefig('Var_12hr_run08.png', format='png')
...
fig,ax0,ax1,ax2,ax3,ax4,ax5 = plot_6panels(Std1b,Std2b,Std3b,Std4b,Std5b,Std6b,
                                          -1E-5,1E-5,cmo.cm.curl,'m s$^{-1}$','std($w^*$)')
print('1 day')
fig.savefig('Std_1day_run08.png', format='png')
...
fig,ax0,ax1,ax2,ax3,ax4,ax5 = plot_6panels(Var1b,Var2b,Var3b,Var4b,Var5b,Var6b,
                                          0,5E-10,cmo.cm.amp,'m$^2$s$^{-2}$','$<w^2>$')
fig.savefig('Var_1day_run08.png', format='png')
...
fig,ax0,ax1,ax2,ax3,ax4,ax5 = plot_6panels(Std1c,Std2c,Std3c,Std4c,Std5c,Std6c,
                                          -1E-5,1E-5,cmo.cm.curl,'m s$^{-1}$','std($w^*$)')
print('2.5 days')
fig.savefig('Std_2p5day_run08.png', format='png')
...
fig.savefig('Var_2p5day_12gr_run08.png', format='png')
...
fig,ax0,ax1,ax2,ax3,ax4,ax5 = plot_6panels(Std1d,Std2d,Std3d,Std4d,Std5d,Std6d,
                                          -1E-5,1E-5,cmo.cm.curl,'m s$^{-1}$','std($w^*$)')
print('5 days')
fig.savefig('Std_4p5day_run08.png', format='png')
...
fig.savefig('Var_4p5day_run08.png', format='png')
...
fig.savefig('Std_12hr_vs_1day_run08.png', format='png')
...
fig.savefig('Std_2p5day_vs_1day_run08.png', format='png')
...
fig.savefig('Std_4p5day_vs_1day_run08.png', format='png')
...
fig.savefig('Var_12hr_vs_1day_run08.png', format='png')
...
fig.savefig('Var_2p5day_vs_1day_run08.png', format='png')
...
fig.savefig('Var_4p5day_vs_1day_run08.png', format='png')
...
filename1 = ('std_var_w_profiles_run08.csv')
df.to_csv(filename1)
print(filename1)
